...
Computing the eight features for each *scholion* once again creates a new, citable edition of the text.  In this edition, the text of each scholion is simply eight successive numeric values from 0 to 1. To train and evaluate an automated classifier, we set aside a randomly selected sample of 100 *scholia* from the main, intermarginal, and interior zones.
